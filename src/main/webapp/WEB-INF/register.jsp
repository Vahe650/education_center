                ...
                <div class="col-md">
                    <div class="login_language_area d-flex align-items-center float-right">
                        ...
                        <div class="login_register">
                            <a href="/"><i class="fa fa-lock" aria-hidden="true"></i> Login/Register</a>
                        </div>
                        <!-- Language Area Start -->
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7 col-xl-6">
                <div class="register_form">
                    <spring:form action="/userRegister" method="post" modelAttribute="user" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <spring:input path="surname" type="text" name="surname" id="user_surname" placeholder="surname"></spring:input>
                        </div>
                        <!-- Single Register input area start  -->
                        <div class="form-group">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                            <spring:input path="email" type="email" name="email" id="email" placeholder="Email"></spring:input>
                        </div>
                        <!-- Single Register input area start  -->
                        <div class="form-group">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                            <spring:input path="password" type="password" name="password" id="pass_b" placeholder="Confirm Password"></spring:input>
                        </div>
                        <!-- Single Register input area start  -->
                        <div class="form-group">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                ...
                <div class="col-12 col-md-6 col-lg">
                    <div class="important_links footer-single-part">
                        ...
                        <div class="links">
                            ...
                            <a href="/studentsView"><i class="fa fa-angle-right" aria-hidden="true"></i> Event Calendar</a>
                            <a href="/studentsView"><i class="fa fa-angle-right" aria-hidden="true"></i> Customer Support</a>
                ...
                <div class="col-12 col-md-6 col-lg">
                    <div class="important_links footer-single-part">
                        ...
                        <div class="newsletter_from">
                            <form action="/">
                                <div class="form-group">
                                    <input type="email" class="form-control" id="newsletter-email" placeholder="Enter Your E-mail" required>
                                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="footer_bottom">
                        <p>Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="/lessonView">Designing World</a></p>
                    </div>
                </div>
            </div>
        </div>
