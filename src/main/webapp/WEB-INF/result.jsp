...
<section class="our_teachers_area our_teacher section_padding_100_70">
    <div class="container">
        <div class="row">
            <span>${message}</span>
            <c:forEach items="${search}" var="one">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="single_teacher_profile item">
                    ...
                    <div class="single_teacher_details_info">
                        <h2>${one.name}</h2>
                        <c:forEach items="${one.lessons}" var="les">
                            ${les.name}
                        </c:forEach>
                        <p>student</p>
...
<div class="popular_coureses_area all_courses grid_list section_padding_100">
    <div class="container">
        <div class="row">
            <c:forEach items="${lessonSearch}" var="one">
                    ...
                    <div class="important_links footer-single-part">
                        ...
                        <div class="links">
                            ...
                            <a href="/"><i class="fa fa-angle-right" aria-hidden="true"></i> Customer
                                Support</a>
                            <a href="/"><i class="fa fa-angle-right" aria-hidden="true"></i> Career at
                                EduCamp</a>
