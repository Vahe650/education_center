                        ...
                        <div class="language_area">
                            <div class="dropdown">
                                ...
                                <ul aria-labelledby="lag" class="dropdown-menu">
                                    <li><a href="teachers.html#">English</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<section class="our_teachers_area our_teacher section_padding_100_70">
    <div class="container">
        <div class="row">
            <spring:forEach items="${users}" var="one">
            <c:if test="${currentUser.type=='USER'}">
            <!-- Single Teacher Area Start -->
            <div class="col-12 col-sm-6 col-md-3">
                <div class="single_teacher_profile item">
                    ...
                    <div class="single_teacher_details_info">
                        <spring:forEach items="${all}" var="oneless">
                        </spring:forEach>
                        <h2>${one.name}</h2>
                        <spring:forEach items="${one.lessons}" var="les">
                                ${les.name}
                        </spring:forEach>
                        <p>student</p>
                        <p><a href="/userProfile?id=${one.id}"><button>Student profile</button></a></p>
                        <!-- Single Teacher Socila Links -->
                        <div class="">
                            <div class="social_icon">
                                <a href="teachers.html#"><i class="fa fa-facebook"></i></a>
                                <a href="teachers.html#"><i class="fa fa-twitter"></i></a>
                                <a href="teachers.html#"><i class="fa fa-skype"></i></a>
                                <a href="teachers.html#"><i class="fa fa-dribbble"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <c:if test="${currentUser.type=='MANAGER'&& one.type!='MANAGER'}">
            <!-- Single Teacher Area Start -->
            <div class="col-12 col-sm-6 col-md-3">
                <div class="single_teacher_profile item">
                    <!-- Single Teacher Thumb -->
                    ...
                    <div class="single_teacher_details_info">
                        <h2>${one.name}</h2>
                        <p><a href="/deleteStudent?id=${one.id}"><button>delete Student</button></a></p>
                        <p><a href="/studentParam?id=${one.id}"><button>change Student data</button></a></p>
                        <p><a href="/userProfile?id=${one.id}"><button>Student profile</button></a></p>
                        <!-- Single Teacher Socila Links -->
                        <div class="">
                            <div class="social_icon">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg">
                    <div class="footer_about_us footer-single-part">
                        ...
                        <div class="footer_social_links">
                            <a href="teachers.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a href="teachers.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                            <a href="teachers.html#"><i class="fa fa-skype" aria-hidden="true"></i></a>
                            <a href="teachers.html#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                            <a href="teachers.html#"><i class="fa fa-youtube" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg">
                    <div class="important_links footer-single-part">
                        ...
                        <!-- Links Start -->
                        <div class="links">
                            <a href="teachers.html#"><i class="fa fa-angle-right" aria-hidden="true"></i> All Our
                                Courses</a>
                            <a href="teachers.html#"><i class="fa fa-angle-right" aria-hidden="true"></i> Event Calendar</a>
                            <a href="teachers.html#"><i class="fa fa-angle-right" aria-hidden="true"></i> Customer
                                Support</a>
                            <a href="teachers.html#"><i class="fa fa-angle-right" aria-hidden="true"></i> Career at
                                EduCamp</a>
                            <a href="teachers.html#"><i class="fa fa-angle-right" aria-hidden="true"></i> Terms &amp;
                                Conditions</a>
                            <a href="teachers.html#"><i class="fa fa-angle-right" aria-hidden="true"></i> Community
                                Forums</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="footer_bottom">
                        <p>Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="teachers.html#">Designing
                            World</a></p>
                    </div>
                </div>
            </div>
